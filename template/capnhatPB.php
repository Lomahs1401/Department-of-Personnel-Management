<?php 
    ...
    $sql = "SELECT IDPB, TenPB, MoTa FROM phongban LIMIT $start_from, $num_per_page;";
        ...
        <div class="container mt-16 table-responsive">
            ...
            <?php  else : ?>
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        <?php foreach ($listDepartments as $index => $department) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="formcapnhatPB.php?idpb=<?php echo htmlspecialchars($department['IDPB']); ?>">Cập nhật</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
