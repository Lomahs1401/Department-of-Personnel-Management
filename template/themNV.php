...
<body>
    <div id="main">
        <h4 class="center mt-16">Thêm mới nhân viên</h4>
        ...
        <?php endif; ?>
        <form action="xulythemNV.php" method="POST" name="form_add" class="mt-16 needs-validation" novalidate>
            <div class="form-group">
                <label for="idnv">Mã nhân viên:</label>
                <input type="text" class="form-control" placeholder="Nhập ID" id="idnv" name="idnv" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="idpb" id="list-department">
                    <?php foreach($listDepartments as $department) : ?>
                        <option value="<?php echo htmlspecialchars($department['IDPB']); ?>">
            ...
            <div class="controls">
                <a href="xemthongtinNV.php" type="button" class="btn btn-primary">Back</a>
