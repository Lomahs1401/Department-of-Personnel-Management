...
<body>
    <div id="main">
        ...
        <div class="container mt-16 table-responsive">
            ...
            <?php  else : ?>
                <form action="xulyxoatatcaNV.php?" method="POST" name="form_delete_all">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="delete_option[]" class="custom-control-input" id="emp<?php echo $index; ?>"
                                                value="<?php echo htmlspecialchars($employee['IDNV']);?>">
                                            <label class="custom-control-label" for="emp<?php echo $index; ?>"></label>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                    ...
                    <div class="controls">
                        <button type="button" id="btn_delete" class="btn btn-danger mt-16">Xác nhận xóa</button>
                    </div>
                </form>
            <?php endif; ?> 
        </div>
        <div class="toast" data-autohide="false">
            ...
            <div class="toast-body text-danger" style="font-weight: bold;">
                <p>Chưa chọn nhân viên cần xóa.</p>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(() => {
            ...
            $('#btn_delete').click(() => {
                ...
                var count = "<?php echo count($listEmployees) ;?>";
                for (var i = 0; i < count; i++) {
                    var checkInput = $('input[id="emp' + i + '"]').is(":checked");
                    if (checkInput === false) {
                        totalUnchecked++;
                    }
                }
                if (count == totalUnchecked) {
                    showToast();
                } else {
